...
<div class="flex gap-4">
	<div class="flex-auto flex flex-col gap-4">
			...
			<div class="card bg-base-200 shadow-xl">
				<div class="card-body">
					<div class="card-actions justify-end">
						...
						<div class="absolute right-0 bottom-0 flex flex-col"></div>
					</div>
					<h2 class="card-title">{player.name}</h2>
					<div class="flex">
						<p class="text-4xl flex-1">
							{currencyPrefix}{player.balance}{currencySuffix}
						</p>
		...
		<form
			class="card w-96 p-4 bg-base-100 shadow-xl gap-4 mx-auto"
			on:submit={onAddPlayerFormSubmit}
		>
